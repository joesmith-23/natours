...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic21pZmZ5aiIsImEiOiJjazE5M2Z6cnAwZXhqM2h0YzFxeXowbXIzIn0.C-8BHzANOLuHQJXi4g0RKQ';
...
var stripe = Stripe('pk_test_k9TP5ijbn7uKsxXTXW7ksDUj');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2. Creat checkout form and charge credit card
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully created an account');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviewSubmit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reviewSubmit = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(review, rating, tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully submitted review');
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
exports.reviewSubmit = reviewSubmit;
...
var _reviewSubmit = require("./reviewSubmit");
...
var rating1 = document.getElementById('label-1');
var rating2 = document.getElementById('label-2');
var rating3 = document.getElementById('label-3');
var rating4 = document.getElementById('label-4');
var rating5 = document.getElementById('label-5');
var radio1 = document.getElementById('rating-1');
